										...
										<form id="login-form" name="login-form" class="mb-0" action="#" method="post">
											...
											<div class="row">
												<div class="col-12 form-group">
                                                    ...
                                                    <input type="checkbox" id ="chooise-form-permissions" name="一般人員">Normal guys
                                                    <input type="checkbox" id ="chooise-form-permissions" name="管理員">Manage guys<br>
												</div>
